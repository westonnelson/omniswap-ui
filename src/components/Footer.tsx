      ...
      <div className="container mx-auto flex flex-col items-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center w-full mb-8">
          <div>
            ...
            <div className="border-t border-gray-500 my-4 mx-auto w-24 md:w-full"></div>
        ...
        <div className="w-full border-t border-gray-500 pt-4">
          <div className="flex flex-col md:flex-row justify-center items-center w-full space-y-4 md:space-y-0 md:space-x-8">
            <div className="flex items-center justify-center mb-4 md:mb-0">
              <Image src="/omniswapwhite.png" alt="OmniSwap" width={40} height={40} />
            </div>
            <div className="flex flex-col md:flex-row md:space-x-4 text-sm text-center md:text-left">
